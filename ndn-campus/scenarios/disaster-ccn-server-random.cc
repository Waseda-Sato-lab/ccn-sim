...
int main (int argc, char *argv[])
{
	...
	*/
	...
	// Obtain metrics
	//ndn::L3AggregateTracer::Install(clientNodes,"l3clients.txt", Seconds (1.0));
	ndn::L3AggregateTracer::Install(nodes_net1[0][5].Get (0),"l3server.txt", Seconds (1.0));
