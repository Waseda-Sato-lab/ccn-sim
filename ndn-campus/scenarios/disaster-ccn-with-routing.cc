...
int main (int argc, char *argv[])
{
	...
	ndnGlobalRoutingHelper.AddOrigins ("/Dinfo/tokyo/shinjuku/waseda-u/waseda", nodes_net1[0][5].Get (0));
	...
	p2p_1gb5ms.EnablePcap ("test1.pcap", nodes_net1[0][5].Get (0)->GetId (), true,true);
